<template>
            ...
            <transition name="fade">
              ...
              <div class="flex items-center gap-3 mb-2">
                <div class="w-10 h-10 bg-gradient-to-br from-violet-500 to-violet-600 rounded-xl flex items-center justify-center shadow-lg">
                  <UtensilsCrossed class="w-6 h-6 mx-3 text-white" />
                </div>
                <h1 class="text-2xl font-bold text-gray-900">F&B Revenue Assumptions</h1>
              </div>
              <p class="text-sm text-gray-500">Manage and configure your F&B revenue data</p>
            </div>
  ...
  import { CircleAlert, AlertTriangle, Calculator, UtensilsCrossed, Table, Download, RefreshCw, FolderOpen, Receipt, Tag, ChevronDown, ChevronRight, ChevronLeft, Hash, Calendar, ArrowLeft, Settings, X, Check, PlusCircle, Plus, Trash2, DollarSign } from 'lucide-vue-next';
