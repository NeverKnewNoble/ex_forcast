<template>
  <div class="flex flex-col items-center justify-center min-h-[400px] bg-white border-2 border-dashed border-violet-300 rounded-xl shadow-sm">
    ...
    <p class="text-gray-500 text-center max-w-md leading-relaxed text-sm">
      {{ fromYear && !toYear
        ? 'You have selected a From Year, now please select a To Year to display reports.'
        : !fromYear && toYear
          ? 'You have selected a To Year, now please select a From Year to display reports.'
          : 'Please select both "From Year" and "To Year" to display reports.' }}
    </p>
